...
type FrontPhotoTutorialNavigationProp = StackNavigationProp<RootStackParamList, 'FrontPhotoTutorial'>;

export function FrontPhotoTutorialScreen() {
    const navigation = useNavigation<FrontPhotoTutorialNavigationProp>();
    ...
    const confirmPhoto = () => {
        ...
        navigation.navigate('ProfilePhotoTutorial', { 
            mode: route.params?.mode,
        ...
        <View className="flex-1 bg-white">
            ...
            <SafeAreaView className="flex-1" edges={['top', 'bottom']}>
                ...
                <View className="flex-1 px-6 justify-start items-center">
                    ...
                    >
                        <Image
                            source={require('../../../../../assets/images/tutorial/tutorial_front.jpg')}
                    ...
                    <View className="w-full space-y-4 mb-8">
                        ...
                        <View className="flex-row items-center mb-6">
                            ...
                            <Text className="flex-1 text-base text-gray-700">
                                No sonrías al mirar a cámara, mantén una expresión normal
                            </Text>
                        </View>
                        ...
                        <View className="flex-row items-center">
                            ...
                            <Text className="flex-1 text-base text-gray-700">
                                Si tienes gafas, quítatelas para obtener mejores resultados
                            </Text>
                        </View>
                    </View>
                </View>
